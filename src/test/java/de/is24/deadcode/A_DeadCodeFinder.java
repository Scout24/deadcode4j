...
public final class A_DeadCodeFinder {
    ...
    public void recognizesASingleClassAsDeadCode() {
        ...
        assertThat("Should analyze one class", deadCode.getAnalyzedClasses(), Matchers.<String>iterableWithSize(1));
        assertThat("Should recognize one class as dead", deadCode.getDeadClasses(), Matchers.<String>iterableWithSize(1));
    }
    ...
    public void recognizesTwoInterdependentClassesAsLiveCode() {
        ...
        assertThat("Should analyze two classes", deadCode.getAnalyzedClasses(), Matchers.<String>iterableWithSize(2));
        assertThat("Should find NO dead code", deadCode.getDeadClasses(), Matchers.<String>iterableWithSize(0));
    }
